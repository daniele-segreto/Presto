<x-layout>
    ...
    <h1 class="text-center mt-4">MODIFICA ANNUNCIO</h1>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3">
                <form method="POST" action="{{route('announcements.edit', compact('announcement'))}}">
                    @csrf
                    @method('put')
                    ...
                    <button type="submit" class="btn btn-outline-dark mt-3">Modifica</button>
                </form>
            </div>
        </div>
    </div>
